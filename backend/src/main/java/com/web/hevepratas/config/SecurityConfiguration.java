...
import com.web.hevepratas.security.JwtCustomAuthenticationFilter;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, LoginSocialSuccessHandler successHandler, JwtCustomAuthenticationFilter jwtCustomAuthenticationFilter) throws Exception {
        return http
                ...
                .addFilterAfter(jwtCustomAuthenticationFilter, BearerTokenAuthenticationFilter.class) //BearerTokenAuthenticationFilter is a filter that receive the token decode it and generate JwtAuthenticationToken.
                .build();
    }
